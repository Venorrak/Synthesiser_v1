...
<div class="container">
  ...
  <div class={primaryClass} bind:this={header}>
    ...
    <a on:click={() => dispatch("stop")}
      ><i class="fa fa-inverse fa-lg fa-stop" /></a
    >
    <a on:click={() => dispatch("clear")}><i class="fa fa-lg fa-trash" /></a>
    <a
      on:click={() => alert("Link copied to clipboard. Paste it to share")}
      class="share"><i class="fa fa-lg fa-share-alt" /></a
    >
