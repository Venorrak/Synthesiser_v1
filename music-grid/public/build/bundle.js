...
var app = (function () {
    ...
    class Controls extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { grid: 5, config: 0 });
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$3, 177, 2, 3507);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a0.hidden = "true";
    			add_location(a0, file$3, 179, 1, 3583);
    			attr_dev(div0, "id", "notesContainer");
    			add_location(div0, file$3, 180, 1, 3665);
    			attr_dev(table, "class", "svelte-wvhii7");
    			add_location(table, file$3, 181, 1, 3698);
    			add_location(br0, file$3, 186, 1, 3857);
