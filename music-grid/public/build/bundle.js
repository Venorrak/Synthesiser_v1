...
var app = (function () {
    ...
    const setSoundEnabled = writable({
    ...
    /* src/Music.svelte generated by Svelte v3.23.2 */
    ...
    /* src/Cell.svelte generated by Svelte v3.23.2 */
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 48, 1, 700);
    			attr_dev(td, "class", "svelte-eszcqg");
    			add_location(td, file, 47, 0, 694);
    		},
    ...
    class Cell extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { active: 0, column: 3, paused: 4 });
    ...
    /* src/Row.svelte generated by Svelte v3.23.2 */
    ...
    function create_each_block(ctx) {
    	...
    	function cell_active_binding(value) {
    		/*cell_active_binding*/ ctx[4].call(null, value, /*cell*/ ctx[5], /*each_value*/ ctx[6], /*index*/ ctx[7]);
    	}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(41:1) {#each row as cell, index}",
    		ctx
    	});
    ...
    class Row extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { row: 0, playing: 1, paused: 2 });
    ...
    /* src/Controls.svelte generated by Svelte v3.23.2 */
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file$2, 112, 8, 2674);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(i, file$2, 110, 8, 2609);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, i, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(110:6) {#if config.playing}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	let input0;
    	let t1;
    	let t2_value = /*config*/ ctx[0].rows + "";
    	let t2;
    	let t3;
    	let br0;
    	let t4;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$2, 84, 6, 2055);
    			add_location(label0, file$2, 82, 4, 2017);
    			add_location(br0, file$2, 94, 4, 2266);
    			attr_dev(input1, "type", "range");
    			attr_dev(input1, "min", "60");
    			attr_dev(input1, "max", "500");
    			attr_dev(input1, "class", "slider");
    			add_location(input1, file$2, 97, 6, 2307);
    			add_location(label1, file$2, 95, 4, 2277);
    			attr_dev(div0, "class", "settings svelte-jgzd42");
    			add_location(div0, file$2, 81, 2, 1990);
    			attr_dev(a0, "class", "svelte-jgzd42");
    			add_location(a0, file$2, 108, 4, 2531);
    			attr_dev(i0, "class", "fa fa-inverse fa-lg fa-stop svelte-jgzd42");
    			add_location(i0, file$2, 116, 7, 2785);
    			attr_dev(a1, "class", "svelte-jgzd42");
    			add_location(a1, file$2, 115, 4, 2741);
    			attr_dev(i1, "class", "fa fa-lg fa-trash svelte-jgzd42");
    			add_location(i1, file$2, 118, 42, 2878);
    			attr_dev(a2, "class", "svelte-jgzd42");
    			add_location(a2, file$2, 118, 4, 2840);
    			attr_dev(i2, "class", "fa fa-lg fa-share-alt svelte-jgzd42");
    			add_location(i2, file$2, 121, 20, 3017);
    			attr_dev(a3, "class", "share svelte-jgzd42");
    			add_location(a3, file$2, 119, 4, 2918);
    			attr_dev(i3, "class", "fa fa-lg fa-download svelte-jgzd42");
    			add_location(i3, file$2, 124, 7, 3114);
    			attr_dev(a4, "class", "svelte-jgzd42");
    			add_location(a4, file$2, 123, 4, 3066);
    			attr_dev(i4, "class", "fa fa-lg fa-lg fa-volume-up svelte-jgzd42");
    			add_location(i4, file$2, 126, 44, 3202);
    			attr_dev(a5, "id", "soundBtn");
    			attr_dev(a5, "class", "svelte-jgzd42");
    			add_location(a5, file$2, 126, 4, 3162);
    			attr_dev(div1, "class", div1_class_value = "" + (null_to_empty(/*primaryClass*/ ctx[3]) + " svelte-jgzd42"));
    			add_location(div1, file$2, 107, 2, 2481);
    			add_location(br1, file$2, 128, 2, 3259);
    			attr_dev(div2, "class", "container");
    			add_location(div2, file$2, 80, 0, 1964);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	let $setSoundEnabled;
    	validate_store(setSoundEnabled, "setSoundEnabled");
    	component_subscribe($$self, setSoundEnabled, $$value => $$invalidate(19, $setSoundEnabled = $$value));
    	...
    	const toggleSound = () => {
    		...
    		set_store_value(setSoundEnabled, $setSoundEnabled = !$setSoundEnabled);
    	...
    	function input0_change_input_handler() {
    		config.rows = to_number(this.value);
    		$$invalidate(0, config);
    	}

    	const input_handler = () => dispatch("rowchange");

    	function input1_change_input_handler() {
    		config.speed = to_number(this.value);
    		$$invalidate(0, config);
    	}
    ...
    class Controls extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*config*/ ctx[0] === undefined && !("config" in props)) {
    			console_1.warn("<Controls> was created without expected prop 'config'");
    		}
    	}
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$3, 204, 2, 4311);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block$1(ctx) {
    	...
    	function row_row_binding(value) {
    		/*row_row_binding*/ ctx[17].call(null, value, /*row*/ ctx[26], /*each_value*/ ctx[27], /*row_index*/ ctx[28]);
    	}

    	function row_playing_binding(value) {
    		/*row_playing_binding*/ ctx[18].call(null, value, /*row*/ ctx[26]);
    	}

    	let row_props = { paused: !/*config*/ ctx[0].playing };

    	if (/*row*/ ctx[26] !== void 0) {
    		row_props.row = /*row*/ ctx[26];
    	}

    	if (/*row*/ ctx[26].isPlaying !== void 0) {
    		row_props.playing = /*row*/ ctx[26].isPlaying;
    	}
    ...
    function create_fragment$3(ctx) {
    	...
    	function controls_grid_binding(value) {
    		/*controls_grid_binding*/ ctx[11].call(null, value);
    	}

    	function controls_config_binding(value) {
    		/*controls_config_binding*/ ctx[12].call(null, value);
    	}
    	...
    	controls.$on("playpause", /*togglePlaying*/ ctx[5]);
    	controls.$on("stop", /*stopPlaying*/ ctx[7]);
    	controls.$on("clear", /*clear_handler*/ ctx[13]);
    	controls.$on("rowchange", /*rowchange_handler*/ ctx[14]);
    	controls.$on("scalechange", /*scalechange_handler*/ ctx[15]);
    	controls.$on("download", /*downloadAudio*/ ctx[10]);
    	controls.$on("mute", /*toggleSound*/ ctx[4]);
    	let if_block = /*recording*/ ctx[3] && create_if_block$1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$3, 191, 1, 3914);
    			attr_dev(a0, "download", "music-grid.wav");
    			a0.hidden = "true";
    			add_location(a0, file$3, 206, 1, 4387);
    			attr_dev(div0, "id", "notesContainer");
    			add_location(div0, file$3, 207, 1, 4469);
    			attr_dev(table, "class", "svelte-wvhii7");
    			add_location(table, file$3, 208, 1, 4502);
    			add_location(br0, file$3, 213, 1, 4661);
    			attr_dev(a1, "href", "https://irshadpi.me/best-of-music-grid");
    			attr_dev(a1, "target", "_blank");
    			attr_dev(a1, "class", "svelte-wvhii7");
    			add_location(a1, file$3, 215, 2, 4706);
    			add_location(br1, file$3, 216, 2, 4798);
    			...
    			add_location(a2, file$3, 217, 2, 4806);
    			attr_dev(div1, "class", "footer svelte-wvhii7");
    			attr_dev(div1, "align", "center");
    			add_location(div1, file$3, 214, 1, 4668);
    			add_location(br2, file$3, 219, 1, 5161);
    			add_location(br3, file$3, 220, 1, 5168);
    			attr_dev(div2, "class", "container svelte-wvhii7");
    			attr_dev(div2, "align", "center");
    			add_location(div2, file$3, 190, 0, 3874);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(table, "click", /*startPlaying*/ ctx[6], { once: true }, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
